    ...
    <section className="h-full max-h-[640px] mb-8 xl:mb-24">
      <div className="flex flex-col lg:flex-row">
        <div className="lg:ml-8 xl:ml-[135px] flex flex-col items-center lg:items-start text-center lg:text-left justify-center flex-1px-4 lg:px-0 h-auto">
          <h1 className="text-2xl lg:text-[72px] lg:ml-4 font-semibold leading-none mb-6">
          ...
          <button className="py-3 px-5 bg-violet-700 rounded-lg text-white lg:ml-4">Join Us</button>
        </div>
        {/* image*/}
